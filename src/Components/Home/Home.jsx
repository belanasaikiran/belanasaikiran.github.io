      ...
      <header className="relative  ">
        ...
        <div>
          ...
          <div className="absolute z-20 text-white flex justify-between w-full px-20 text-2xl bottom-24 2xl:px-60 lg:px-40 ">
            ...
            <div className="  group border-2 bg-skin ">
              <div className="bg-cyan-600 p-2  translate-x-[-7px] translate-y-[-7px]  transition-all duration-700 group-hover:translate-x-0 group-hover:translate-y-0">
                {" "}
                Hire Me
              </div>
            </div>
